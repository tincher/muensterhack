...
def get_test_waypoints() -> list[Waypoint]:
    return [
        Waypoint(
            ...
            pp_rollstuhlgerecht_level=RollstuhlgerechtLevel.VOLL,
            pp_ueberdacht=True,
            pp_schranke=False,
            pp_kostenlos=False,
            pp_belegt=False,
        ...
        Waypoint(
            ...
            pp_rollstuhlgerecht_level=RollstuhlgerechtLevel.UNBEKANNT,
            pp_ueberdacht=False,
            pp_schranke=False,
            pp_kostenlos=True,
            pp_belegt=None,
        ...
        Waypoint(
            ...
            pp_rollstuhlgerecht_level=RollstuhlgerechtLevel.NICHT,
            pp_ueberdacht=True,
            pp_schranke=True,
            pp_kostenlos=False,
            pp_belegt=True,
        ...
        Waypoint(
            ...
            pp_rollstuhlgerecht_level=RollstuhlgerechtLevel.TEILWEISE,
            pp_ueberdacht=False,
            pp_schranke=False,
            pp_kostenlos=False,
            pp_belegt=False,
